...
const NIGERIA_RE = new RegExp(
  [
    ...
    'birnin gwari', 'sambisa', 'bama', 'gwoza', 'damboa', 'konduga',
    'zuru', 'tambuwal', 'faskari', 'kankara', 'chikun', 'kajuru', 'zangon kataf',
    'lafia', 'minna', 'suleja', 'makurdi', 'gboko', 'otukpo', 'logo', 'guma',
    'bokkos', 'barkin ladi', 'mangu', 'wukari', 'jalingo', 'owo', 'aba',
